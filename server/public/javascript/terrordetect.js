...
function genPostBody() {
    ...
    let guns = document.querySelector('#wa_filter_input_cate_terror').checked;
    let islamic = document.querySelector('#wa_filter_input_cate_bomb').checked;
    let knives = document.querySelector('#wa_filter_input_cate_march').checked;
    let isis = document.querySelector('#wa_filter_input_cate_fight').checked;
    ...
    postBody.body = JSON.stringify({
        ...
        enddate: end,
        score: [score, 1],
        cate: [guns?'guns':'', islamic?'islamic flag':'',knives?'knives':'', isis?'isis flag':'']
    });
}
